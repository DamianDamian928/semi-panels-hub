...
export const sources = [
  ...
  },
  {
    ...
    status: 'Needs check',
    usedFor: ['BOM'],
    expectedFormat: 'Read-only HTTP API returning Fusion BOM component rows',
    lastChecked: 'Not checked',
    owner: 'Damian',
    description: 'Read-only PLM Utility API source for current Fusion BOM structure filtered by effective dates.',
    accessMode: 'Read-only',
  },
  {
    id: '7',
...
export const validationStatesBySource = {
  ...
  'PLMAccelerate SQL': { state: 'Not checked', message: 'SQL profile has not been configured yet.' },
  'Fusion BOM API': { state: 'Not checked', message: 'Fusion BOM API source registered. Waiting for access check.' },
...
export const reviewIssues = [
  ...
  },
  {
    ...
    comparedWith: 'PLMAccelerate SQL',
    decision: 'None',
    owner: 'Damian',
    updated: 'May 5, 13:05',
...
export const outputItems = [
  ...
  },
  {
    ...
    sourceBasis: 'Mass Production vs PLMAccelerate SQL',
    outputImpact: 'No output impact yet',
  ...
  },
  {
    ...
    sourceBasis: 'Parts&BOM vs PLMAccelerate SQL',
    outputImpact: 'Affects output',
